...
export const api = {
  ...
  updateContentPhase: (id, phase, b) => req(`/content/${id}/phases/${phase}`, { method:'PATCH', body:JSON.stringify(b) }),
  ...
  updateTodo:     (id, b) => req(`/waypoint/todos/${id}`,         { method:'PATCH', body:JSON.stringify(b) }),
